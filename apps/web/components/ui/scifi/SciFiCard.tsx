  ...
  ({ 
    ...
    return (
      ...
      >
              ...
              {title && (
                <h3 
                  className={cn(
                    ...
                    glow ? `text-[${themeHex}] drop-shadow-[0_0_8px_${themeHex}60]` : "text-foreground"
                  )}
        ...
        <div className={cn("flex-1", contentPadding, contentClassName)}>
          {children}
        </div>
        ...
        {footer && (
          <div 
            className={cn(
              "border-t border-[var(--asteroid-dust-50)]",
              footerPadding
            )}
          >
            {footer}

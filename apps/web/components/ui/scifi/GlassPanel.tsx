...
export const GlassPanel = forwardRef<HTMLDivElement, GlassPanelProps>(
  (
    ...
    return (
      <div
        ref={ref}
        className={`relative overflow-hidden holo-shimmer ${glowClass} ${className} ${hoverClass}`}
        style={combinedStyle}
        {...props}
      >
        {/* Top edge lighting */}
        <div
          ...
          style={{
            background: `linear-gradient(90deg, transparent, ${themeHex}15, ${themeHex}25, ${themeHex}15, transparent)`,
          }}
        />

        ...
        >
            ...
            >
                <defs>
                    ...
                    <linearGradient id={maskGradId} gradientUnits="objectBoundingBox" x1="0" y1="0" x2="1" y2="0">
                    ...
                    <mask id={maskId}>
                        <rect x={-50} y={-50} width={width + 100} height={h + 100} fill={`url(#${maskGradId})`} />
                    </mask>
                ...
                <g mask={`url(#${maskId})`}>
                    ...
                    <g style={{ animation: `wash-line-${id} ${safeDuration}s ease-in-out infinite` }}>
                        <path d={pathD} fill="none" stroke={`url(#${gradId})`} strokeWidth={glowStrokeWidth} filter={`url(#${glowId})`} opacity="0.2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d={pathD} fill="none" stroke={`url(#${gradId})`} strokeWidth={coreStrokeWidth} strokeLinecap="round" strokeLinejoin="round" />
                        <path d={pathD} fill="none" stroke="white" strokeWidth={highlightStrokeWidth} opacity="0.3" strokeLinecap="round" strokeLinejoin="round" />
                    </g>

                    <g style={{ animation: `wash-line-${id} ${safeDuration}s ease-in-out infinite`, animationDelay: `-${halfDuration}s` }}>
                        <path d={pathD} fill="none" stroke={`url(#${gradId})`} strokeWidth={glowStrokeWidth} filter={`url(#${glowId})`} opacity="0.2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d={pathD} fill="none" stroke={`url(#${gradId})`} strokeWidth={coreStrokeWidth} strokeLinecap="round" strokeLinejoin="round" />
                        <path d={pathD} fill="none" stroke="white" strokeWidth={highlightStrokeWidth} opacity="0.3" strokeLinecap="round" strokeLinejoin="round" />
                    </g>

  ...
  if (!character) {
    return (
      <GlassPanel theme="cyan" variant="default" className="p-4 h-full flex flex-col">
        <div className="flex items-center gap-2 mb-3 pb-2 border-b" style={{ borderColor: `${THEME_HEX.cyan}20` }}>
    ...
    <GlassPanel theme="cyan" variant="default" className="p-4 h-full flex flex-col">
      ...
      <div className="space-y-4 flex-1 overflow-y-auto">
        <div>
          ...
          <div className={`text-lg font-semibold ${character.name ? 'text-heading' : 'text-subtle italic'}`}>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          >
            ...
            <div>
              ...
              <div className="text-lg font-mono text-heading">Cr{character.credits.toLocaleString()}</div>
            </div>
          </div>
        </div>
               ...
               ? (
                 ...
                 >
                   {character.terms[character.terms.length - 1].careerId} 
                    <span className="text-subtle ml-2">Rank {character.terms[character.terms.length - 1].currentRank}</span>
                 </span>
               )

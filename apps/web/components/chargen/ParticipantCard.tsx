    ...
    return (
      <div className="bg-zinc-950 border border-zinc-800 rounded-lg p-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-zinc-400 text-sm">Not started</span>
        </div>
        <p className="text-zinc-600 text-xs ml-5 mt-1">Waiting to begin...</p>
      </div>
    );
  }
  ...
  return (
    <div
      className={`
        ...
        ${onViewProgress ? 'cursor-pointer hover:bg-zinc-900' : ''}
      `}
    ...
    >
      <div className="flex justify-between items-start mb-2">
        <div>
          ...
          {awareness?.step && (
            <div className="text-zinc-500 text-xs ml-5 mt-0.5 italic">
      ...
      {onViewProgress && (
        <button className="mt-2 text-xs text-blue-400 hover:text-blue-300 ml-5">
          [View Progress]
        </button>
      )}

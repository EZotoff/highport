...
export function LifepathTimeline({ characterId, onEntityClick }: LifepathTimelineProps) {
  ...
  return (
    <GlassPanel className="flex flex-col w-full h-full overflow-hidden" variant="elevated">
      ...
      <div className="relative flex-1 overflow-x-auto overflow-y-hidden custom-scrollbar" style={{ background: 'var(--deep-void)' }}>
        <div 
            ...
            <div className="flex px-1 pb-2 relative">
              ...
              {terms.map((term, i) => (
                ...
                >
                  ...
                  <span className="group-hover:text-[var(--plasma-cyan)] transition-colors">AGE {term.startAge}</span>
                </div>
              ))}
            ...
            {terms.length === 0 ? (
               ...
               >
                 <div 
                    ...
                    style={{
                      backgroundImage: 'radial-gradient(circle at center, var(--plasma-cyan) 0.5px, transparent 1px)',
                 ...
                 <p className={`${TYPOGRAPHY.subheading} text-[var(--text-secondary)] mb-2 tracking-widest uppercase text-sm`}>
                   Begin Your Journey
                 </p>
      ...
      <div className="relative z-10">
        ...
        <div className="flex-1 min-w-[200px]">
          <div className={`flex items-center gap-2 mb-2 ${TYPOGRAPHY.label}`} style={{ color: THEME_HEX.cyan }}>
          ...
          <div className="flex flex-wrap gap-2 max-h-20 overflow-y-auto custom-scrollbar">
            {Object.keys(totalSkills).length > 0 ? (
              ...
              <span className="italic text-xs" style={{ color: `${THEME_HEX.cyan}60` }}>None yet</span>
            )}
          </div>
        </div>

        <div className="flex-1 min-w-[200px] border-t sm:border-t-0 sm:border-l pt-4 sm:pt-0 sm:pl-6" style={{ borderColor: 'var(--asteroid-dust-50)' }}>
          <div className={`flex items-center gap-2 mb-2 ${TYPOGRAPHY.label}`} style={{ color: THEME_HEX.emerald }}>
          ...
          <div className="flex flex-wrap gap-2 max-h-20 overflow-y-auto custom-scrollbar">
            {totalBenefits.length > 0 ? (
              ...
              <span className="italic text-xs" style={{ color: `${THEME_HEX.emerald}60` }}>None yet</span>
            )}
          </div>
        </div>
      </div>

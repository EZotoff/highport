...
export const THEME_STYLES: Record<ThemeColor, ThemeStyleSet> = {
  ...
  violet: {
    ...
    borderB: 'border-b-violet-500/30',
  ...
  emerald: {
    ...
    borderB: 'border-b-emerald-500/30',
  ...
  slate: {
    ...
    borderB: 'border-b-slate-500/30',
    iconBg: 'bg-slate-500/20',
    iconText: 'text-slate-300',
    actionText: 'text-slate-400',
  ...
  switch (variant) {
    ...
    case 'secondary':
      return {
        ...
        className:
          'border hover:bg-[var(--theme-hover-bg)] hover:border-[var(--theme-hover-border)]',
      };
    case 'ghost':
      return {
        style: {
        ...
        className:
          'bg-transparent hover:bg-[var(--theme-hover-bg)] hover:text-[var(--theme-hover-text)]',
      };
    case 'outline':
      return {
        style: {
...
const THEME_CONFIG = {
  cyan: {
    ...
    border: {
      400: 'border-cyan-400',
      '500/20': 'border-cyan-500/20',
      '500/30': 'border-cyan-500/30',
      '500/50': 'border-cyan-500/50',
    },
    ...
    hoverBorder: {
      ...
      '500/30': 'hover:border-cyan-500/30',
      '400/50': 'hover:border-cyan-400/50',
    },
  },
  violet: {
    text: {
    ...
    border: {
      ...
      '500/20': 'border-violet-500/20',
      '500/30': 'border-violet-500/30',
      '500/50': 'border-violet-500/50',
    },
    ...
    hoverBorder: {
      ...
      '500/30': 'hover:border-violet-500/30',
      '400/50': 'hover:border-violet-400/50',
    },
  },
  amber: {
    text: {
    ...
    border: {
      ...
      '500/20': 'border-amber-500/20',
      '500/30': 'border-amber-500/30',
      '500/50': 'border-amber-500/50',
    },
    ...
    hoverBorder: {
      ...
      '500/30': 'hover:border-amber-500/30',
      '400/50': 'hover:border-amber-400/50',
    },
  },
  emerald: {
    text: {
    ...
    bg: {
      '500/5': 'bg-emerald-500/5',
      '500/10': 'bg-emerald-500/10',
      '500/20': 'bg-emerald-500/20',
    },
    border: {
      400: 'border-emerald-400',
      '500/20': 'border-emerald-500/20',
      '500/30': 'border-emerald-500/30',
      '500/50': 'border-emerald-500/50',
    },
    ...
    hoverBorder: {
      ...
      '500/30': 'hover:border-emerald-500/30',
      '400/50': 'hover:border-emerald-400/50',
    },
  },
  red: {
    text: {
    ...
    border: {
      400: 'border-red-400',
      '500/20': 'border-red-500/20',
      '500/30': 'border-red-500/30',
      '500/50': 'border-red-500/50',
    },
    ...
    hoverBorder: {
      ...
      '500/30': 'hover:border-red-500/30',
      '400/50': 'hover:border-red-400/50',
    },
  },
  slate: {
    text: {
    ...
    border: {
      ...
      '500/20': 'border-slate-500/20',
      '500/30': 'border-slate-500/30',
      '500/50': 'border-slate-500/50',
    },
    ...
    hoverBorder: {
      ...
      '500/30': 'hover:border-slate-500/30',
      '400/50': 'hover:border-slate-400/50',
    },
  },
};
...
export const getThemeTextClass = (
  theme: string,
  shade: 100 | 200 | 300 | 400 | 500 = 400,
): string => THEME_CONFIG[getThemeKey(theme)].text[shade];

export const getThemeBgClass = (
  theme: string,
  opacity: '500/5' | '500/10' | '500/20' = '500/10',
): string => THEME_CONFIG[getThemeKey(theme)].bg[opacity];

export const getThemeBorderClass = (
  theme: string,
  variant: 400 | '500/20' | '500/30' | '500/50' = 400,
): string => THEME_CONFIG[getThemeKey(theme)].border[variant];

export const getThemeRingClass = (theme: string, variant: '500/30' = '500/30'): string =>
  THEME_CONFIG[getThemeKey(theme)].ring[variant];

export const getThemeShadowClass = (
  theme: string,
  variant: '500/20' | '500/40' = '500/20',
): string => THEME_CONFIG[getThemeKey(theme)].shadow[variant];
...
export const getThemeHoverBorderClass = (
  theme: string,
  variant: 400 | '500/30' | '400/50' = 400,
): string => THEME_CONFIG[getThemeKey(theme)].hoverBorder[variant];

...
- **Join Buttons**: "Try to Join" buttons use cyan outline instead of the specified violet outline for secondary actions. However, they effectively denote the primary action _within_ each card while remaining secondary to the main "Continue" action.
